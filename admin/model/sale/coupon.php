...
class ModelSaleCoupon extends Model {
	public function addCoupon($data) {
		...
		if (isset($data['coupon_case'])) {
			foreach ($data['coupon_case'] as $case_id) {
				$this->db->query("INSERT INTO " . DB_PREFIX . "coupon_case SET coupon_id = '" . (int)$coupon_id . "', case_id = '" . (int)$case_id . "'");
			}
		}
	...
	public function editCoupon($coupon_id, $data) {
		...
		$this->db->query("DELETE FROM " . DB_PREFIX . "coupon_case WHERE coupon_id = '" . (int)$coupon_id . "'");
	...
	public function getCouponCases($coupon_id) {
		$coupon_case_data = array();

		$query = $this->db->query("SELECT * FROM " . DB_PREFIX . "coupon_case WHERE coupon_id = '" . (int)$coupon_id . "'");

		foreach ($query->rows as $result) {
			$coupon_case_data[] = $result['case_id'];
		}

		return $coupon_case_data;
	}
