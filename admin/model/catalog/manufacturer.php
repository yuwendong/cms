...
class ModelCatalogManufacturer extends Model {
	public function addConditionManufacturer($name) {
		$query = $this->db->query("SELECT DISTINCT *, (SELECT keyword FROM " . DB_PREFIX . "url_alias WHERE query = 'manufacturer_id=" . (int)$manufacturer_id . "') AS keyword FROM " . DB_PREFIX . "manufacturer WHERE name = '" .$this->db->escape($name) . "'");
