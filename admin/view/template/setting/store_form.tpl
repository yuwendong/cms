      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
        ...
        <div id="tab-image">
          <table class="form">
            ...
            <tr>
              <td><span class="required">*</span> <?php echo $entry_image_case; ?></td>
              <td><input type="text" name="config_image_case_width" value="<?php echo $config_image_case_width; ?>" size="3" />
                x
                <input type="text" name="config_image_case_height" value="<?php echo $config_image_case_height; ?>" size="3" />
                <?php if ($error_image_case) { ?>
                <span class="error"><?php echo $error_image_case; ?></span>
                <?php } ?></td>
            </tr>
            <tr>
