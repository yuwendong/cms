    ...
    <div class="content">
      <div class="overview">
        ...
        <div class="dashboard-content">
          <table>
            <tr>
              <td><?php echo $text_total_case; ?></td>
              <td><?php echo $total_case; ?></td>
            </tr>
            <tr>
      ...
      <div class="latest">
        ...
        <div class="dashboard-content">
          <table class="list">
            <thead>
              <tr>
                <td class="left"><?php echo $column_case_model; ?></td>
                <td class="left"><?php echo $column_case_name; ?></td>
                <td class="left"><?php echo $column_case_tag; ?></td>
                <td class="left"><?php echo $column_case_figure; ?></td>
                <td class="left"><?php echo $column_case_spread; ?></td>
                <td class="left"><?php echo $column_case_time; ?></td>
                <td class="left"><?php echo $column_case_location; ?></td>
                <td class="center" width="36"><?php echo $column_action; ?></td>
              </tr>
            </thead>
            <tbody>
              <?php if ($cases) { ?>
