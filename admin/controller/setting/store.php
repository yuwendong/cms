...
class ControllerSettingStore extends Controller {
	...
	public function getForm() { 
		...
		$this->data['entry_image_case'] = $this->language->get('entry_image_case');
		...
		if (isset($this->error['image_case'])) {
			$this->data['error_image_case'] = $this->error['image_case'];
		} else {
			$this->data['error_image_case'] = '';
		}
		...
		if (isset($this->request->post['config_image_case_width'])) {
			$this->data['config_image_case_width'] = $this->request->post['config_image_case_width'];
		} elseif (isset($store_info['config_image_case_width'])) {
			$this->data['config_image_case_width'] = $store_info['config_image_case_width'];		
		} else {
			$this->data['config_image_case_width'] = 80;
		}

		if (isset($this->request->post['config_image_case_height'])) {
			$this->data['config_image_case_height'] = $this->request->post['config_image_case_height'];
		} elseif (isset($store_info['config_image_case_height'])) {
			$this->data['config_image_case_height'] = $store_info['config_image_case_height'];		
		} else {
			$this->data['config_image_case_height'] = 80;
		}
	...
	protected function validateForm() {
		...
		if (!$this->request->post['config_image_case_width'] || !$this->request->post['config_image_case_height']) {
			$this->error['image_case'] = $this->language->get('error_image_case');
		}
