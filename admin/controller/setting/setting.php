...
class ControllerSettingSetting extends Controller {
	...
	public function index() {
		...
		$this->data['entry_case_count'] = $this->language->get('entry_case_count');
		...
		if (isset($this->request->post['config_case_count'])) {
			$this->data['config_case_count'] = $this->request->post['config_case_count'];
		} else {
			$this->data['config_case_count'] = $this->config->get('config_case_count');
		}
		...
		if (isset($this->request->post['config_image_case_width'])) {
			...
			$this->data['config_image_case_width'] = $this->config->get('config_image_case_width');
		}
		...
		if (isset($this->request->post['config_image_case_height'])) {
			...
			$this->data['config_image_case_height'] = $this->config->get('config_image_case_height');
		}
