...
class ControllerCatalogReview extends Controller {
	...
	protected function getList() {
		...
		$this->data['sort_case'] = $this->url->link('catalog/review', 'token=' . $this->session->data['token'] . '&sort=pd.name' . $url, 'SSL');
	...
	protected function getForm() {
		...
		if (isset($this->request->post['case_id'])) {
			...
			$this->data['case_id'] = $review_info['case_id'];
		} else {
			$this->data['case_id'] = '';
		}
		...
		if (isset($this->request->post['case'])) {
			...
			$this->data['case'] = $review_info['case'];
		} else {
			$this->data['case'] = '';
		}
