...
class ControllerSaleCoupon extends Controller {
	...
	protected function getForm() {
		...
		if (isset($this->request->post['coupon_case'])) {
			$cases = $this->request->post['coupon_case'];
		} elseif (isset($this->request->get['coupon_id'])) {		
			$cases = $this->model_sale_coupon->getCouponCases($this->request->get['coupon_id']);
		} else {
			$cases = array();
		}
