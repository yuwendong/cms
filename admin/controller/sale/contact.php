				...
				switch ($this->request->post['to']) {
					...
					case 'case':
						if (isset($this->request->post['case'])) {
							$email_total = $this->model_sale_order->getTotalEmailsByCasesOrdered($this->request->post['case']);	

							$results = $this->model_sale_order->getEmailsByCasesOrdered($this->request->post['case'], ($page - 1) * 10, 10);
