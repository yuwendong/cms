...
class ControllerCommonHeader extends Controller {
	protected function index() {
		...
		$this->data['text_keyfigures'] = $this->language->get('text_keyfigures');
		$this->data['text_label'] = $this->language->get('text_label');
		$this->data['text_contenttype'] = $this->language->get('text_contenttype');
		$this->data['text_contentcolumn'] = $this->language->get('text_contentcolumn');
		...
		$this->data['text_report_case_viewed'] = $this->language->get('text_report_case_viewed');
		$this->data['text_report_case_purchased'] = $this->language->get('text_report_case_purchased');
		...
		if (!$this->user->isLogged() || !isset($this->request->get['token']) || !isset($this->session->data['token']) || ($this->request->get['token'] != $this->session->data['token'])) {
			...
			$this->data['keyfigures'] = $this->url->link('catalog/keyfigures', 'token=' . $this->session->data['token'], 'SSL');
			$this->data['label'] = $this->url->link('catalog/label', 'token=' . $this->session->data['token'], 'SSL');
			$this->data['contenttype'] = $this->url->link('catalog/contenttype', 'token=' . $this->session->data['token'], 'SSL');
			$this->data['contentcolumn'] = $this->url->link('catalog/contentcolumn', 'token=' . $this->session->data['token'], 'SSL');
			...
			$this->data['case'] = $this->url->link('catalog/case', 'token=' . $this->session->data['token'], 'SSL');
			...
			$this->data['report_case_viewed'] = $this->url->link('report/case_viewed', 'token=' . $this->session->data['token'], 'SSL');
			$this->data['report_case_purchased'] = $this->url->link('report/case_purchased', 'token=' . $this->session->data['token'], 'SSL');
