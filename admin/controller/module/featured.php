...
class ControllerModuleFeatured extends Controller {
	...
	public function index() {   
		...
		if (isset($this->request->post['featured_case'])) {
			$this->data['featured_case'] = $this->request->post['featured_case'];
		} else {
			$this->data['featured_case'] = $this->config->get('featured_case');
		}	

		$this->load->model('catalog/case');

		if (isset($this->request->post['featured_case'])) {
			$cases = explode(',', $this->request->post['featured_case']);
		} else {		
