...
<div id="content"><?php echo $content_top; ?>
  ...
  <table class="list">
    ...
    <tbody>
      ...
      <tr>
        <td class="left"><?php echo $case['name']; ?>
          <?php foreach ($case['option'] as $option) { ?>
          <br />
          &nbsp;<small> - <?php echo $option['name']; ?>: <?php echo $option['value']; ?></small>
          <?php } ?></td>
        <td class="left"><?php echo $case['model']; ?></td>
        <td class="right"><?php echo $case['quantity']; ?></td>
        <td class="right"><?php echo $case['price']; ?></td>
        <td class="right"><?php echo $case['total']; ?></td>
        <td class="right"><a href="<?php echo $case['return']; ?>"><img src="catalog/view/theme/default/image/return.png" alt="<?php echo $button_return; ?>" title="<?php echo $button_return; ?>" /></a></td>
      </tr>
      <?php } ?>
