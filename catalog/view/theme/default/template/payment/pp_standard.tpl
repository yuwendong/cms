...
<form action="<?php echo $action; ?>" method="post">
  ...
  <input type="hidden" name="item_name_<?php echo $i; ?>" value="<?php echo $case['name']; ?>" />
  <input type="hidden" name="item_number_<?php echo $i; ?>" value="<?php echo $case['model']; ?>" />
  <input type="hidden" name="amount_<?php echo $i; ?>" value="<?php echo $case['price']; ?>" />
  <input type="hidden" name="quantity_<?php echo $i; ?>" value="<?php echo $case['quantity']; ?>" />
  <input type="hidden" name="weight_<?php echo $i; ?>" value="<?php echo $case['weight']; ?>" />
  <?php $j = 0; ?>
