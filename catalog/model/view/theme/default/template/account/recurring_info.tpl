  ...
  <table class="list">
    ...
    <tr>
        ...
        <td class="left" style="width: 50%; vertical-align: top;">
            <p style="margin:5px;"><b><?php echo $text_case; ?></b> <a href="<?php echo $profile['case_link']; ?>"><?php echo $profile['case_name']; ?></a></p>
            <p style="margin:5px;"><b><?php echo $text_quantity; ?></b> <?php echo $profile['case_quantity']; ?></p>
