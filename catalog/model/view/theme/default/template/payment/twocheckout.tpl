<form action="<?php echo $action; ?>" method="post">
  ...
  <input type="hidden" name="c_prod_<?php echo $i; ?>" value="<?php echo $case['case_id']; ?>,<?php echo $case['quantity']; ?>" />
  <input type="hidden" name="c_name_<?php echo $i; ?>" value="<?php echo $case['name']; ?>" />
  <input type="hidden" name="c_description_<?php echo $i; ?>" value="<?php echo $case['description']; ?>" />
  <input type="hidden" name="c_price_<?php echo $i; ?>" value="<?php echo $case['price']; ?>" />
  <?php $i++; ?>
  <?php } ?>
