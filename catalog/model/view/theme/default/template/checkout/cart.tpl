            ...
            <?php if($case['recurring']): ?>
              <tr>
                  <td colspan="6" style="border:none;"><image src="catalog/view/theme/default/image/reorder.png" alt="" title="" style="float:left;" /><span style="float:left;line-height:18px; margin-left:10px;"> 
                      ...
                      <?php echo $case['profile_description'] ?>
                  </td>
                </tr>
            <?php endif; ?>
          <tr>
            <td class="image"><?php if ($case['thumb']) { ?>
              ...
              <?php } ?></td>
            <td class="name"><a href="<?php echo $case['href']; ?>"><?php echo $case['name']; ?></a>
              <?php if (!$case['stock']) { ?>
              ...
              <div>
                ...
                <?php } ?>
                <?php if($case['recurring']): ?>
                - <small><?php echo $text_payment_profile ?>: <?php echo $case['profile_name'] ?></small>
                <?php endif; ?>
              </div>
              <?php if ($case['reward']) { ?>
              <small><?php echo $case['reward']; ?></small>
              <?php } ?></td>
            <td class="model"><?php echo $case['model']; ?></td>
            <td class="quantity"><input type="text" name="quantity[<?php echo $case['key']; ?>]" value="<?php echo $case['quantity']; ?>" size="1" />
              &nbsp;
              <input type="image" src="catalog/view/theme/default/image/update.png" alt="<?php echo $button_update; ?>" title="<?php echo $button_update; ?>" />
              &nbsp;<a href="<?php echo $case['remove']; ?>"><img src="catalog/view/theme/default/image/remove.png" alt="<?php echo $button_remove; ?>" title="<?php echo $button_remove; ?>" /></a></td>
            <td class="price"><?php echo $case['price']; ?></td>
            <td class="total"><?php echo $case['total']; ?></td>
          </tr>
          <?php } ?>
