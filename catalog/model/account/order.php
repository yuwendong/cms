...
class ModelAccountOrder extends Model {
	...
	public function getOrderOptions($order_id, $order_case_id) {
		$query = $this->db->query("SELECT * FROM " . DB_PREFIX . "order_option WHERE order_id = '" . (int)$order_id . "' AND order_case_id = '" . (int)$order_case_id . "'");
	...
	public function getTotalOrderCasesByOrderId($order_id) {
		$query = $this->db->query("SELECT COUNT(*) AS total FROM " . DB_PREFIX . "order_case WHERE order_id = '" . (int)$order_id . "'");
