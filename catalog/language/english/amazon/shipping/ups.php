...
$_['entry_origin']                 = 'Shipping Origin Code:<span class="help">What origin point should be used (this setting affects only what UPS label names are shown to the user)</span>';
...
$_['entry_test']                   = 'Test or Caseion Mode:<span class="help">Use this module in Test or Caseion mode?</span>';
...
$_['entry_insurance']              = '启用保险:<span class="help">Enables insurance with label total as the value</span>';
