...
$_['lang_sync_import_line1']            = '<strong>Caution!</strong> This will import all of your eBay labels and build a category structure in your store. It is advised that you delete all categories and labels before you run this option. <br />The category structure is from the normal eBay categories, not your shop categories (if you have an eBay shop). You can rename, remove and edit the imported categories without affecting your eBay labels.';
$_['lang_sync_import_line2']            = 'This option uses a lot of calls to the API, one for every label plus 1 extra call every 20 items.';
...
$_['lang_ajax_import_confirm']          = 'This will import all of your eBay items as new labels, are you sure? This CAN NOT be undone! ENSURE you have a backup first!';
