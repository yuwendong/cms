...
$_['button_new'] = 'Create new label';
$_['button_return'] = 'Back to labels';
$_['button_amazon_price'] = "Get Amazon's price";
$_['button_list'] = "List on Amazon";

//Text
$_['text_labels_sent'] = 'Cases were sent for processing';
...
$_['help_sku'] = "Unique label's ID assigned by the merchant";
...
$_['lang_placeholder_search'] = 'Enter label name, UPC, EAN, ISBN or ASIN';
$_['lang_placeholder_condition'] = 'Use this box to describe the condition of your labels.';
...
$_['quick_listing_description'] = 'Use this method when matching label already exist in Amazon catalogue. Matching is found by Amazon using Standard label id (ASIN, ISBN, UPS, EAN)';
$_['advanced_listing_description'] = 'Use this method to create new listings on Amazon.';
$_['listing_row_text'] = 'Listing for label:';
$_['already_saved_text'] = 'This label is already in saved listings. Click edit if you want to revise.';
...
//Saved listings tab
$_['saved_listings_description'] = 'This is the list of label listings which are saved locally and ready to be uploaded to Amazon. Click upload to post.';
...
$_['upload_failed'] = 'Failed uploading label with SKU: "%s". Reason: "%s" Uploading process canceled.';
...
$_['links_desc2_text'] = 'You can link items manualy by entering Amazon SKU and label name or load all unlinked labels and then enter amazon SKUs. (Uploading labels from OpenCart to Amazon will automaticaly add links)';
$_['links_load_btn_text'] = 'Load';
$_['links_new_link_text'] = 'New link';
$_['links_autocomplete_label_text'] = 'Case<span class="help">(Autocomplete from name)</span>';
...
$_['links_name_empty_warning'] = 'Case name can not be empty!';
$_['links_label_warning'] = 'Case does not exist. Please use autocomplete values.';
$_['option_default'] = '-- Select option --';

//Listing edit page
$_['text_edit_heading'] = 'Listing overview';
$_['text_has_saved_listings'] = 'This label has one or more localy saved listings.';
$_['text_label_links'] = 'Case links';
...
$_['error_sending_labels'] = 'Could not send labels for listing. Please contact OpenBay Pro support';
$_['lang_no_results'] = 'No results found';
$_['error_no_labels_selected'] = 'No labels were selected for listing';

//Messages
$_['text_label_sent'] = 'Case was successfully sent to Amazon.';
$_['text_label_not_sent'] = 'Case was not sent to Amazon. Reason: %s';
$_['text_links_removed'] = 'Amazon label links deleted';
