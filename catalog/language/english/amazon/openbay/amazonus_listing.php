...
$_['text_label_sent'] = 'Case was successfully sent to Amazon US.';
$_['text_label_not_sent'] = 'Case was not sent to Amazon US. Reason: %s';
...
$_['quick_listing_description'] = 'Use this method when matching label already exist in Amazon US catalogue. Matching is found by Amazon US using Standard label id (ASIN, ISBN, UPS, EAN)';
...
$_['links_desc2_text'] = 'You can link items manualy by entering Amazon US SKU and label name or load all unlinked labels and then enter amazon SKUs. (Uploading labels from OpenCart to Amazon will automaticaly add links)';
