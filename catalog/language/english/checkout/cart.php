...
// Heading  
$_['heading_title']          = '购物车内的案例';

// Text
$_['text_success']           = '成功添加案例<a href="%s">%s</a> 到您的 <a href="%s">购物车</a>！';
...
// Error
$_['error_stock']            = '案例标有 *** 表示数量不足或没有存货！';	
$_['error_minimum']          = '%s 最小起订量是 %s！';	
$_['error_required']         = '%s 要求！';	
$_['error_case']          = '警告： 您的购物车内没有案例！';	
